	...
	return (
		<div className="w-full lg:w-1/3 text-gray-200 pb-4">
			...
			<div className="w-full p-4">
				<div className="border-2 border-primary p-0.5">
					<div className="border border-primary p-3">
						<div className="mb-3 text-center text-gray-200 text-lg font-semibold">
							2026年4月
						</div>
						<div className="grid grid-cols-7 gap-1 text-center text-xs text-beige">
							{weekDays.map((day) => (
			...
			<div className="w-full px-4 text-gray-200 space-y-2">
				...
				<div className="border-2 border-orange-700/70 rounded-md p-4">
					...
					<div className="flex justify-start items-center gap-2">
						...
						<span className="text-gray-200">20:00～20:30</span>
					</div>
					<div className="flex justify-start items-center gap-2 mt-2">
						<RiMapPinFill className="scale-75" />
						<span className="text-gray-200">オンライン (Zoom)</span>
					</div>
				</div>
				<div className="border-2 border-green-800/70 rounded-md p-4">
					...
					<div className="flex justify-start items-center gap-2">
						<RiTimeFill className="scale-75" />
						<span className="text-gray-200">13:00～16:00</span>
					</div>
					<div className="flex justify-start items-center gap-2 mt-2">
						<RiMapPinFill className="scale-75" />
						<span className="text-gray-200">江戸川橋</span>
					</div>
					<div className="flex justify-start items-center gap-2 mt-2">
						<RiMoneyCnyCircleFill className="scale-75" />
						<span className="text-gray-200">500円</span>
					</div>
				</div>
