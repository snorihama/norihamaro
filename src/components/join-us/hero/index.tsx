	...
	return (
		...
		>
			...
			<div className="h-lvh flex flex-col gap-10 justify-center items-center w-screen md:w-[50vw] flex-1 z-10 px-20 max-w-screen md:max-w-[48vw]">
				...
				{/* Main Text Block */}
				<div className="w-[90vw] md:w-lg max-w-full flex flex-col gap-4 items-center md:items-start relative">
					{/* Date with red vertical line */}
					<div className="flex w-full justify-center items-center">
						<span className="text-beige text-center text-[1.1rem] tracking-widest font-[zenOldMincho,serif]">
							2025年度五月祭
						</span>
					</div>
					{/* Main Title */}
					...
					/>
					{/* Description */}
					<p className="text-[#f1ebd7] text-base md:text-[1.15rem] leading-8 max-w-[90vw] md:max-w-lg pt-6 font-[zenOldMincho,serif] [text-shadow:0_2px_8px_rgba(0,0,0,0.3)] text-center md:text-left">
